...
def _attn_fwd_tile(
    ...
    """
    Triton kernel for Fused Multi-Head Attention (FMHA) with tile-based processing.
    Uses a flattened loop structure with outer TILE_X loop.
    """
...
def triton_fmha(Q, K, V, qk_scale=None, input_pos=0, tile_m=128, tile_n=64, query_group_size=1, causal=False):
    """
    Triton FMHA with tile-based processing.
    """
    BLOCK_M = tile_m
    BLOCK_N = tile_n
