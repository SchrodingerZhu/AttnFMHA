...
def _attn_fwd_fully_static(
    ...
    """
    Triton kernel for FMHA with fully static scheduling.
    All tiles across batches and heads are distributed round-robin across NUM_VSM blocks.
    """
    pid = tl.program_id(0)
...
def triton_fmha(Q, K, V, qk_scale=None, input_pos=0, tile_m=128, tile_n=64, query_group_size=1, causal=False):
    """
    Triton FMHA with fully static scheduling across all batches and heads.
    """
    BLOCK_M = tile_m
    BLOCK_N = tile_n
